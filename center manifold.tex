...
\begin{align*}
M(g)(v,\omega)={}g_v(v,\omega)[P^cAv+z(\omega)+P^cG(\omega,v+ g)]
\\
...
Set
\begin{align*}
M(y)(0,v,\omega)={}& \,y_v(0,v,\omega)[P^cAv+z(\omega)+P^cG(\omega, y(0,v,\omega))]\\&{} -Ay(0,v,\omega)-z(\omega)y(0,v,\omega)+P^s G(\omega, y(0,v,\omega))\\&{} -P^uG(\omega, y(0,v,\omega)),\end{align*}
where $v\in H^c$.
...
\exp[A(t-s)]
P^cG(\omega,u(s))\,ds\\&{}
+\int^{+\infty}_{-\infty}B(t-s)\exp(-z(\omega))G(\omega,u(s))\,ds\,.
\end{split}
\end{align}
...
\begin{align*}
&J^c(y(0,u_c,\omega)+w(0,u_c,\omega),0)=\\&\quad\quad \quad\quad \int^{+\infty}_{-\infty}B(-s)\exp(-z(\omega))G(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))\,ds\,.
\end{align*}
Select a  initial condition $z(omega)$ such that $\alpha>-z(\omega)>-\beta$. So
\begin{align*}
&y(0,u_c,\omega)\\={}&\int_{-\infty}^0\frac d{ds}\left[\exp(-As)\exp(-z(\omega))P^sy(0,u_c(s,v,\omega),\omega)\right]\,ds\\&{} -\int^{\infty}_0\frac d{ds}\left[\exp(-As)\exp(-z(\omega))P^uy(0,u_c(s,v,\omega),\omega)\right]\,ds
\\  ={}&\int_{-\infty}^0\ \exp(-As)\exp(-z(\omega))\bigg[(-A-z(\omega))P^sy(0,u_c(s,v,\omega),\omega)\\&{} +\frac d{ds}P^sy(0,u_c(s,v,\omega),\omega)\bigg]\,ds-\int^{\infty}_0\exp(-As)\\ &
...
={}&(-A-z(\omega))P^sy(0,u_c(s,v,\omega),\omega)+P^sy_v(0,u_c(s,v,\omega),\omega)[Au_c\\&{}+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]\\
...
={}&(-A-z(\omega))P^uy(0,u_c(s,v,\omega),\omega)+P^uy_v(0,u_c(s,v,\omega),\omega)[Au_c\\&{}+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]\\={}&M(P^uy)-P^uy_v(0,u_c(s,v,\omega),\omega)[P^cG(\omega,y(0,u_c,\omega))\\&{} -P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]+P^uG(\omega,y(0,u_c,\omega)).  \end{align*}
...
\begin{eqnarray}
\frac {ds}{dt} \sin x%+\sum_{n=2}^\infty \frac {\partial c_n(s,\omega)}{\partial s}\sin nx+ \sum_{n=2}^\infty\frac {\partial c_n(s,\omega)}{\partial t}\sin nx\nonumber\\&\quad=\sum_{n=2}^\infty[1-n^2+z(\theta_t\omega)] c_n(s,\omega)\sin nx
=s\sigma z(\theta_t\omega)\sin x\nonumber-\frac 3 4{\exp[2\sigma z(\theta_t\omega)]} as^3\sin x+\Ord{s^5}.
\label{pa2}
\end{eqnarray}
...
\begin{align*}
M(h^c)(v,\omega)={}&\,h_v^c(v,\omega)[P^cAv+z(\omega)+P^cG(\omega, v+h^c)]-Ah^c\\&{}-z(\omega)h^c -P^s G(\omega,  v+h^c)-P^uG(\omega,  v+h^c),
\end{align*}
