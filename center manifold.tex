...
\begin{align*}
M(g)(v,\omega)={}& 
g_t(v,\omega)+g_v(v,\omega)[P^cAv+P^cG(\omega,v+ g)]
\\&{}
-Ag-P^s G(\omega, v+g)-P^uG(\omega, v+ g),
\end{align*}
where $v\in H^c$.
...
Set
\begin{align*}
M(y)(0,v,\omega)={}& \,y_v(0,v,\omega)[P^cAv+P^cG(\omega, y(0,v,\omega))]\\&{} -Ay(0,v,\omega)-P^s G(\omega, y(0,v,\omega))\\&{} -P^uG(\omega, y(0,v,\omega)),\end{align*}
where $v\in H^c$.
...
\exp[A(t-s)]
P^cG(\omega,u(s))\,ds\\&{}
+\int^{+\infty}_{-\infty}B(t-s)G(\omega,u(s))\,ds\,.
\end{split}
\end{align}
...
\begin{align*}
&J^c(y(0,u_c,\omega)+w(0,u_c,\omega),0)=\\&\quad\quad \quad\quad \int^{+\infty}_{-\infty}B(-s)G(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))\,ds\,.
\end{align*}
Since
\begin{align*}
&y(0,u_c,\omega)\\={}&\int_{-\infty}^0\frac d{ds}\left[\exp(-As)P^sy(0,u_c(s,v,\omega),\omega)\right]\,ds\\&{} -\int^{\infty}_0\frac d{ds}\left[\exp(-As)P^uy(0,u_c(s,v,\omega),\omega)\right]\,ds
\\  ={}&\int_{-\infty}^0\ \exp(-As)\bigg[-AP^sy(0,u_c(s,v,\omega),\omega)\\&{} +\frac d{ds}P^sy(0,u_c(s,v,\omega),\omega)\bigg]\,ds-\int^{\infty}_0\exp(-As)\\ &
\left[-AP^uy(0,u_c(s,v,\omega),\omega)
 +\frac d{ds}P^uy(0,u_c(s,v,\omega),\omega)\right]\,ds\,.
 \end{align*}
Here
\begin{align*}
& -AP^sy(0,u_c(s,v,\omega),\omega)+\frac d{ds}P^sy(0,u_c(s,v,\omega),\omega)\\
={}&-AP^sy(0,u_c(s,v,\omega),\omega)+P^sy_v(0,u_c(s,v,\omega),\omega)[Au_c\\&{}+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]\\
...
\begin{align*}  & -AP^uy(0,u_c(s,v,\omega),\omega)+\frac d{ds}P^uy(0,u_c(s,v,\omega),\omega)\\
={}&-AP^uy(0,u_c(s,v,\omega),\omega)+P^uy_v(0,u_c(s,v,\omega),\omega)[Au_c\\&{}+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]\\={}&M(P^uy)-P^uy_v(0,u_c(s,v,\omega),\omega)[P^cG(\omega,y(0,u_c,\omega))\\&{} -P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]+P^uG(\omega,y(0,u_c,\omega)).  \end{align*}
From the above calculations
\begin{align*}
&J^c(y(0,u_c,\omega)+w(0,u_c,\omega),0)-y(0,u_c,\omega)\\
&\quad\quad=\int_{-\infty}^0\exp(-As)Q^s\,ds+\int^{\infty}_0\exp(-As)Q^u\,ds\,,
 \end{align*}
...
\begin{equation*}M^c(\omega)=\{s\sin x+h^c(s\sin x,\omega)\}=\left \{s \sin x + \sum_{n=2}^\infty c_n(t,s,\omega)\sin nx\right \},\end{equation*}
where $c_n(t,s,\omega)=\Ord{s^3}$ as $s\to 0$ for $\omega\in \Omega$\,.
...
\begin{eqnarray}
\frac {ds}{dt} \sin x%+\sum_{n=2}^\infty \frac {\partial c_n(t,s,\omega)}{\partial s}\sin nx+ \sum_{n=2}^\infty\frac {\partial c_n(t,s,\omega)}{\partial t}\sin nx\nonumber\\&\quad=\sum_{n=2}^\infty[1-n^2+z(\theta_t\omega)] c_n(t,s,\omega)\sin nx
...
For $\omega\in \Omega$, $c_n(t,s,\omega)$ is odd functions of  $s$ since $-u$ is a solution of equation \eqref{pa1}. The coefficient $c_n(t,s,\omega)$ is zero for odd term,
so%\marginpar{??what evidence is there that this form is good??  do not assume: argue it must follow.}
\begin{equation*}h^c(s\sin x,\omega)= c_3(t,s,\omega)\sin 3x+\Ord{s^5}.
\end{equation*}
From $c_3(t,s,\omega)=\Ord{s^3}$,  we obtain %\marginpar{??where from?? x-ref, justify}
\begin{eqnarray*}
...
\begin{align*}
M(h^c)(v,\omega)={}&\,h_v^c(v,\omega)[P^cAv+P^cG(\omega, v+h^c)]-Ah^c\\&{} -P^s G(\omega,  v+h^c)-P^uG(\omega,  v+h^c),
\end{align*}
and $h^c(v,\omega)=c_3(t,s,\omega)\sin 3x$\,, the coefficients yield
 \begin{eqnarray*}c_3(t,s,\omega)= \frac 1{ 32} a s^3\exp[2\sigma z(\omega)]. \end{eqnarray*}
So
%\marginpar{I am still not happy with $1/[ {8-z(\theta_t\omega)}]$ ??  and I suspect related to neglect of $\partial_t c_n$.  What happens when rare events case a division by zero??}
 \begin{equation*}h^c(s\sin x,\omega)= \frac 1 {32} a s^3\exp[2\sigma z(\omega)]\sin 3x+\Ord{s^5}. \end{equation*}
...
\begin{eqnarray}&&
s\sin x+\tilde h^c(s\sin x,\omega) = s\sin x+\frac 1{32} a   s^3\sin 3x+\Ord{s^5, \sigma^2}, \label{cas1}
\\&&\text{such that}\quad
\frac {ds}{dt} = s\sigma z(\theta_t\omega)-\frac 3 4  as^3+\Ord{s^5,\sigma^2}. \nonumber
\end{eqnarray}
