...
But the assumption of exponential dichotomy~\cite{Duan1, Duan2}  is not a sufficient condition for proving the existence of center manifolds. For example,   a  generator of a strongly continuous semigroup  has some of its spectrum on the imaginary axis,    which implies  the existence of  center manifolds, but there is no exponential dichotomy
