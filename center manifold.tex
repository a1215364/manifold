...
define
\begin{align*}
M(g)(v,\omega)={}& \,g_v(v,\omega)[P^cAv+P^cG(\omega,v+ g)]-Av\\&{}-P^s G(\omega, v+g)-P^uG(\omega, v+ g),\end{align*}
where $v\in H^c$.
...
From the formulation of approximation of  center manifild, 
\begin{align*}
M(h^c)(v,\omega)={}&\,h_v^c(v,\omega)[P^cAv+P^cG(\omega, v+h^c)]-Ah^c\\&{} -P^s G(\omega,  v+h^c)-P^uG(\omega,  v+h^c),
\end{align*}
and $h^c(v,\omega)=c_3(t,s,\omega)\sin 3x$\,, the coefficients yieds:
...
Denote the noise $\phi_k(t)=\exp[-(k^2-1)\star W(t)$, $\phi(t)$ is a noise  dependant on $\phi_k(t)$, %\marginpar{??This convolution looks wrong too.  Check??} 
 then
\begin{eqnarray}
  u= s\sin x + \frac 1 {32} as^3 \sin 3x -\frac 1 {16} as^3\sigma \phi_3(t)\sin 3x+\Ord{s^5, a^2,\sigma^2}\label{cas2}\\
\mbox{such that } \frac {ds}{dt}= s\sigma \phi(t) -\frac 3 4 as^3 +  \Ord{s^5, a^3,\sigma^2}.  \nonumber
 \end{eqnarray}
