...
and $h^c(v,\omega)=c_3(t,s,\omega)\sin 3x$\,, the coefficients yieds:
 \begin{eqnarray*}c_3(t,s,\omega)= \frac 1{ 32} a s^3. \end{eqnarray*}
So
%\marginpar{I am still not happy with $1/[ {8-z(\theta_t\omega)}]$ ??  and I suspect related to neglect of $\partial_t c_n$.  What happens when rare events case a division by zero??}
 \begin{equation*}h^c(s\sin x,\omega)= \frac 1 {32} a s^3\exp[2\sigma z(\theta_t\omega)]\sin 3x+\Ord{s^5}. \end{equation*}
