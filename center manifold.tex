...
\dot{v}=P^cAv+z(\theta_t\omega)v+P^cG(\theta_t\omega, v+h^c(v,\theta_t\omega)).
\end{equation}
...
In this section, we prove  existence an  approximation of the stochastic center manifolds. We avoid  assuming the   differentiable  noise in the proof process~\cite{Box1}.  
...
\begin{align*}
M(g)(v,\omega)={}g_t(v,\omega)+g_v(v,\omega)[P^cAv+z(\omega)+P^cG(\omega,v+ g)]
\\
-Ag-z(\omega)g-P^s G(\omega, v+g)-P^uG(\omega, v+ g),
\end{align*}
where $v\in H^c$.
...
The function~$y(t,v,\omega)$ connects the functions~$h^c(v,\omega)$ and~$g(v,\omega)$.
Set
\begin{align*}
M(y)(0,v,\omega)={}&y_t(0,v,\omega) +y_v(0,v,\omega)[P^cAv+z(\omega)+P^cG(\omega, y(0,v,\omega))]\\&{} -Ay(0,v,\omega)-z(\omega)y(0,v,\omega)+P^s G(\omega, y(0,v,\omega))\\&{} -P^uG(\omega, y(0,v,\omega)),\end{align*}
where $v\in H^c$.
For a  $\mathcal{F}$-measurable function~$w(t,v,\theta_{-t}\omega)$, define the operator
\begin{equation*}Sw=J^c (w(t,v,\theta_{-t}\omega)+y(t,v,\theta_{-t}\omega),v)-y(t,v,\theta_{-t}\omega),\end{equation*}
where the operator~$J^c$ is defined by
\begin{align}\label{eq(3.221)}\begin{split}
J^c(u,v):={}&\exp(At)v+\int_0^t
\exp[A(t-s)]
P^cG(\omega,u(s))\,ds\\&{}
+\int^{+\infty}_{-\infty}B(t-s)\exp(-z(\omega)s)G(\omega,u(s))\,ds\,.
\end{split}
\end{align}
...
From the construction of~$Y(\omega)$,  $Y(\omega)$~is closed in~$C_\eta$.
Since $J^c$~is a contraction mapping on~$C_\eta$, $S$~is a contracting mapping on~$Y(\omega)$.
We prove that there exist a random variable~$K(\omega)$ such that $S$ maps~$Y(\omega)$ into~$Y(\omega)$.
Then by the uniqueness of fixed points and definition of~$h^c$ we conclude the theorem.

 Now we prove there exists~$Y(\omega)$.
For $w\in C_\eta$,  let $u_c(t,v,\theta_{-t}\omega)$ be the solution of
\begin{align}\label{eq(6.1)}
&  \frac {du_c} {dt}=Au_c+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega)),\nonumber\\ &u_c(0,v,\omega)=v.
 \end{align}
     From equation~\eqref{eq(3.221)}
\begin{align*}
&J^c(y(0,u_c,\omega)+w(0,u_c,\omega),0)=\\&\quad\quad \quad\quad \int^{+\infty}_{-\infty}B(-s)\exp(-z(\omega)s)G(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))\,ds\,.
\end{align*}
Select a  initial condition $z(\omega)$ such that $\alpha>-z(\omega)>-\beta$. So
\begin{align*}
&y(0,u_c,\omega)\\={}&\int_{-\infty}^0\frac d{ds}\left[\exp(-As)\exp(-z(\omega)s)P^sy(0,u_c(s,v,\omega),\omega)\right]\,ds\\&{} -\int^{\infty}_0\frac d{ds}\left[\exp(-As)\exp(-z(\omega)s)P^uy(0,u_c(s,v,\omega),\omega)\right]\,ds
\\  ={}&\int_{-\infty}^0\ \exp(-As)\exp(-z(\omega)s)\bigg[(-A-z(\omega))P^sy(0,u_c(s,v,\omega),\omega)\\&{} +\frac d{ds}P^sy(0,u_c(s,v,\omega),\omega)\bigg]\,ds-\int^{\infty}_0\exp(-As)\exp(-z(\omega)s)\\\ &
\left[(-A-z(\omega))P^uy(0,u_c(s,v,\omega),\omega)
 +\frac d{ds}P^uy(0,u_c(s,v,\omega),\omega)\right]\,ds\,.
 \end{align*}
Here
\begin{align*}
& (-A-z(\omega))P^sy(0,u_c(s,v,\omega),\omega)+\frac d{ds}P^sy(0,u_c(s,v,\omega),\omega)\\
={}&(-A-z(\omega))P^sy(0,u_c(s,v,\omega),\omega)+P^sy_v(0,u_c(s,v,\omega),\omega)[Au_c\\&{}+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]+P^sy_s(0,u_c(s,v,\omega),\omega)\\
={}&M(P^sy)-P^sy_v(0,u_c(s,v,\omega),\omega)[Au_c+P^cG(\omega,y(0,u_c,\omega))]\\&{} +P^sG(\omega,P^sy(0,u_c,\omega))+P^sy_v(0,u_c(s,v,\omega),\omega)\\&\left[Au_c+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))\right]\\
={}&M(P^sy)-P^sy_v(0,u_c(s,v,\omega),\omega)[P^cG(\omega,y(0,u_c,\omega))\\ &{}-P^cG(\omega,y(0,u_c,\omega) +w(0,u_c,\omega))]+P^sG(\omega,y(0,u_c,\omega)).   \end{align*}
\begin{align*}  & (-A-z(\omega))P^uy(0,u_c(s,v,\omega),\omega)+\frac d{ds}P^uy(0,u_c(s,v,\omega),\omega)\\
={}&(-A-z(\omega))P^uy(0,u_c(s,v,\omega),\omega)+P^uy_v(0,u_c(s,v,\omega),\omega)[Au_c\\&{}+P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]+P^uy_s(0,u_c(s,v,\omega),\omega)\\={}&M(P^uy)-P^uy_v(0,u_c(s,v,\omega),\omega)[P^cG(\omega,y(0,u_c,\omega))\\&{} -P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]+P^uG(\omega,y(0,u_c,\omega)).  \end{align*}
From the above calculations
\begin{align*}
&J^c(y(0,u_c,\omega)+w(0,u_c,\omega),0)-y(0,u_c,\omega)\\
&\quad\quad=\int_{-\infty}^0\exp(-As)\exp(-z(\omega))Q^s\,ds+\int^{\infty}_0\exp(-As\exp(-z(\omega)))Q^u\,ds\,,
 \end{align*}
 where $Q^s$ and $Q^u$ is \begin{align*}
 Q^s(y,w,\omega)={}&P^sy_v(0,u_c(s,v,\omega),\omega)[P^cG(\omega,y(0,u_c,\omega))-P^cG(\omega,y(0,u_c,\omega)\\&{} +w(0,u_c,\omega))]
-M(P^sy)+[P^sG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))\\&{} -P^sG(\omega,y(0,u_c,\omega))],\\
Q^u(y,w,\omega)={}&M(P^uy)-P^sy_v(0,u_c(s,v,\omega),\omega)[P^cG(\omega,y(0,u_c,\omega))\\&\-P^cG(\omega,y(0,u_c,\omega)+w(0,u_c,\omega))]
-[P^uG(\omega,y(0,u_c,\omega)\\&{} +w(0,u_c,\omega))-P^uG(\omega,y(0,u_c,\omega))].
\end{align*}
...
\begin{align*}
M(h^c)(v,\omega)={}&\,h_t^c(v,\omega)+h_v^c(v,\omega)[P^cAv+z(\omega)+P^cG(\omega, v+h^c)]-Ah^c\\&{}-z(\omega)h^c -P^s G(\omega,  v+h^c)-P^uG(\omega,  v+h^c),
\end{align*}
...
\begin{eqnarray*}
h_u^c(u,\omega)[-\exp(\sigma z(\omega))uh^c(u,\omega)]+(v-\DD xv)-\exp(\sigma z(\theta_t\omega))u^2\\{}\quad\quad +2\exp(2\sigma z(\theta_t\omega))\cK(u^2h^c(u,\omega))=0.
\end{eqnarray*}
From the construction of operator $\cKo$,  above system of \spde{}s \eqref{2} has an stochastic slow manifold of \begin{eqnarray*}v=h(u,\omega)=\exp(\sigma z(\omega))\cKo u^2.\end{eqnarray*}
